...
public class CursorScript : MonoBehaviour 
{
	...
	void Start () 
	{
		...
		GameObject.Find ("Close").GetComponent<Button> ().onClick.AddListener (DisplayPopupIfSuccesful);
	...
	// the other success message
	void SetSuccess() {
		isSuccess = true;
		popupText.text = GameObject.Find ("Direction").GetComponentInChildren<Text> ().text;
	}

	void DisplayPopupIfSuccesful() {
		if (isSuccess) {
